class Animation:
    def __init__(self, sprite_sheet, animation_steps, animation_speed):
        ...
        for x in range(self.animation_steps):
            self.animation_list.append(self.sprite_sheet.get_image(x, 47, 150, 3))
    ...
    def animate(self, delta_time):
        ...
        if self.animation_timer >= self.animation_speed:
            ...
            self.current_frame = (self.current_frame + 1) % self.animation_steps
            self.animation_timer = 0.0
