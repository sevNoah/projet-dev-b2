...
class OptionsMenu:
    def __init__(self, screen, game):
        ...
        # Dictionnaire pour mapper les codes des boutons aux noms des boutons de la manette
        self.button_names = {
            0: "X",
            1: "Circle",
            2: "Square",
    ...
    def update_game_buttons(self):
        # Mettre à jour les boutons du jeu avec les valeurs configurées
        for option in self.options:
            if option["name"] == "Bouton Coup de Pied":
                self.game.kick_button = option["value"]
            elif option["name"] == "Bouton Coup de Poing":
                self.game.punch_button = option["value"]
            elif option["name"] == "Bouton Hadouken":
    ...
    def draw(self):
        ...
        title = self.font.render("Options de la Manette", True, (255, 255, 255))
